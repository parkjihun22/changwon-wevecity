...
const section3Contents = [
  ...
  },
  {
    ...
    title: "PREMIUM 02",
    text1: `압도적인 스카이 라인뷰`,
    text2: `대전 최초의 스카이라운지, 스카이게스트<br />
			      사계절 천혜를 뷰를 자랑하는 파노라마 뷰`,
  ...
  },
  {
    ...
    title: "PREMIUM 04",
    text1: `청정 힐링라이프`,
    text2: `단지 앞 댗너천, 시민현수공원과 <br />
			      식장산,보문산을 누리는 쾌적한 주거공간`,
        ...
        <>
          ...
          <div className={styles.section}>
            <div className={styles.section1}>
              <div className={styles.textBox}>
                ...
                - 대전의 첫번째 "롯데캐슬" 브랜드프리미엄
              <br />
                - 압도적 미래가치 , 인접한 생활이프라
              <br />
                - 단지 앞 대천천, 시민현수공원과 식장산 , 보문산등
            ...
            <div className={styles.section8}>
              <div className={styles.textBox}>
                <div className={styles.title}>
                  소수만 누릴 수 있는<br />
                  <span>최고의 브랜드 아파트<br /> 대전 롯데캐슬 더퍼스트</span>
                </div>
              ...
              <img src={section8Img3} alt="대전 롯데캐슬 더퍼스트 입지환경소개-image2" />
            </div>
          </div>
          ...
          <div className={styles.section}>
            <div className={styles.section2}>
              ...
              <img
                src={section2_Image1}
                alt="대전 롯데캐슬 더퍼스트아파트 조감도-image3"
              />
            </div>
          </div>
          ...
          <div className={styles.section}>
            <div className={styles.section4}>
              <div className={styles.imageBox}>
                <img src={section4_Image1} alt="대전 롯데캐슬 더퍼스트 브랜드소개-image4" />
                <div className={styles.text1}>대전 롯데캐슬 더퍼스트</div>
    ...
    <button type="submit">등록하기</button>
          ...
          {/* <div className={styles.section}>
            <div className={styles.section9}>
              ...
              <img src={map1} alt="대전 롯데캐슬 더퍼스트 오시는길안내-image1" />
            </div>
          </div> */}
        ...
        <div className={styles.mobileMain}>
          ...
          <div className={styles.imageContainer}>
            <img
              src={mobileImageMain}
              className={styles.mainImage}
              alt="대전 롯데캐슬 더퍼스트 mobilemain-image1"
            />
            <div className={styles.overlay}></div>
          ...
          <div className={styles.container7}>
            ...
            <img
              src={section8Img3}
              alt="대전 롯데캐슬 더퍼스트 mobile입지안내-image1"
            />
          </div>
          ...
          <div className={styles.container3}>
            <div className={styles.textbox}>
              ...
              <div className={`${styles.text4} fadeUpRepeat`}>
                살수록 자부심이 차원이 다른
                <br />
                프리미엄 주거라이프를 대전 롯데캐슬 더퍼스트 <br />
                모델하우스에서 확인하세요
              </div>
            </div>
            <img
              src={section2_Image1}
              alt="대전 롯데캐슬 더퍼스트 mobile조감도-image1"
            />
          </div>
          ...
          <div className={styles.container2}>
            <div>
              <img
                src={section1_Image1}
                alt="대전 롯데캐슬 더퍼스트 브랜드소개 mobile-image5"
              />
          ...
          {/* <div className={styles.section}>
            <div className={styles.section9}>
              <img src={mobilemap1} alt="대전 롯데캐슬 더퍼스트 오시는길안내-mobileimage2" />
            </div>
          </div> */}
