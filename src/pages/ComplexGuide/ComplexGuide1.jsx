  ...
  return (
    <div className={styles.container}>
      <Helmet>
        ...
        {/* SEO 최적화를 위한 메타 태그 */}
        <title>대전 가오동 롯데캐슬더퍼스트 - 단지배치도</title>
        <meta
          name="description"
          content="대전 가오동 롯데캐슬더퍼스트의 단지 배치도를 통해 각 동의 위치와 편의시설의 배치를 확인하세요. 효율적인 동선 설계와 조경 공간, 입주민의 생활 편의를 고려한 배치를 상세히 안내합니다.
								"
        />
        <meta
          name="keywords"
          ...
          {`
																		{
																			...
																			"@type": "WebPage",
																			"name": "대전 가오동 롯데캐슬더퍼스트 - 단지배치도",
																			"description": "대전 가오동 롯데캐슬더퍼스트의 단지 배치도를 통해 각 동의 위치와 편의시설의 배치를 확인하세요. 효율적인 동선 설계와 조경 공간, 입주민의 생활 편의를 고려한 배치를 상세히 안내합니다.",
      ...
      <h1 className={styles.screenReaderOnly}>
        대전 가오동 롯데캐슬더퍼스트 - 단지배치도
      </h1>
      <p className={styles.screenReaderOnly}>
        단지 배치도 페이지는 대전 가오동 롯데캐슬더퍼스트의 전체 단지 구성도를
      ...
      <img
				...
				src={page1}
				alt="대전 가오동 롯데캐슬더퍼스트단지배치도-image1"
