  ...
  return (
    <div className={styles.container}>
      <Helmet>
        ...
        {/* SEO 최적화를 위한 메타 태그 */}
        <title>대전 롯데캐슬 더퍼스트 - 호수배치도</title>
        <meta
          name="description"
          content="대전 롯데캐슬 더퍼스트의 단지호수배치도를 통해 각 동의 위치와 편의시설의 배치를 확인하세요. 효율적인 동선 설계와 조경 공간, 입주민의 생활 편의를 고려한 배치를 상세히 안내합니다"
        />
				<meta
					name="keywords"
        ...
        <link
          rel="canonical"
          href="https://locamobility.co.kr/ComplexGuide/detailintro"
        />

        {/* Open Graph - 소셜 미디어 공유 최적화 */}
        <meta
          property="og:title"
          content="대전 롯데캐슬 더퍼스트 - 호수배치도"
        />
        <meta
        ...
        <meta
          ...
          content="대전 롯데캐슬 더퍼스트의 호수배치도를 통해 각 동의 위치와 편의시설의 배치를 확인하세요. 효율적인 동선 설계와 조경 공간, 입주민의 생활 편의를 고려한 배치를 상세히 안내합니다"
        />
        <meta
          name="twitter:image"
          content="https://locamobility.co.kr/Main1.png"
        ...
        <script type="application/ld+json">
          {`	{		"@context": "https://schema.org",		"@type": "WebPage",		"name": "대전 롯데캐슬 더퍼스트 - 호수배치도", "description": "대전 롯데캐슬 더퍼스트의 단지호수배치도를 통해 각 동의 위치와 편의시설의 배치를 확인하세요. 효율적인 동선 설계와 조경 공간, 입주민의 생활 편의를 고려한 배치를 상세히 안내합니다 ",		"url": "https://locamobility.co.kr/ComplexGuide/detailintro"	}	`}
        </script>
      </Helmet>
