  ...
  return (
    <BrowserRouter>
        <Routes>
          ...
          <Route path="/FloorPlan/74A" element={<FloorPlan5 />} />
          <Route path="/FloorPlan/74B" element={<FloorPlan6 />} />
          <Route path="/FloorPlan/114A" element={<FloorPlan7 />} />
          <Route path="/FloorPlan/114B" element={<FloorPlan8 />} />
          <Route path="/FloorPlan/114C" element={<FloorPlan9 />} />
